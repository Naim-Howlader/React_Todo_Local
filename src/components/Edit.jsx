...
export default function Edit({updateTodoHandler,currentTodo,setCurrentTodo,setIsEditing}) {
  return (
    ...
    <div className="relative">
        ...
        <input  value={currentTodo} type="text" onChange={(e)=>setCurrentTodo(e.target.value)} id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-0"/>
        <div className=''>
